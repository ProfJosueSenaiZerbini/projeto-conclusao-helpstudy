...
1. Pré-requisitos
Node.js 18+
MySQL 8+ rodando localmente (ou em Docker)
...
Todas as rotas (exceto cadastro/login) exigem o token JWT, enviado automaticamente pelo front-end via cookie httpOnly e também salvo no localStoragParticipantes
Diego Nicoletti Gazano (Lider)
Alice Mendoça Ferreira
Luanna Moreira Santos
Joao Vitor Silva
...
O aluno responde questões de uma matéria; cada resposta é salva em respostas.
A cada resposta, progresso é recalculado (% de acerto e nível sugerido: fácil/médio/difícil).
Ao acessar o Plano de Estudos, o sistema ordena as matérias pelo pior desempenho (ou nunca estudadas) e recomenda até 4 delas, com prioridade alta, média ou baixa.
As telas de Progresso mostram gráficos (Chart.js) com a evolução dos últimos 7 dias e o desempenho por matéria, ajudando o aluno (e um professor/responsável) a visualizar onde reforçar os estudos.
🎨 Identidade visual
...
Feito com 💗 para apoiar alunos com dificuldades de aprendizagem.e para uso no header Authorization: Bearer <token>.
